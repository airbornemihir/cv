...
\name{Mihir Mehta\\[12pt]} % the \\[12pt] adds a blank line after name

%% \address{Department of Computer Science \\University of Texas at Austin }
%% \address{Intel Corporation \\ Santa Clara, California}

\address{+1 512-952-0104 \\ \url{www.cs.utexas.edu/~mihir} \\ mihir@cs.utexas.edu}
...
\section{Professional Experience}
 ...
 \item Helping fix bugs found in the process of verifying hardware designs.
 \end{itemize}

 {\bf Research Intern} at Oracle Corp., Belmont, CA, USA. \hfill (May
 2018-Aug 2018)
 \begin{itemize} \itemsep -2pt  % reduce space between items
 \item Completed a code proof to certify the correctness of a highly
   optimised assembly language program.
 \item Contributed to a timing analysis of this program, for
   avoidance of race conditions.
 \item Studied and documented the potential use of the TLAPS theorem prover for
   distributed systems.
 \end{itemize}

 {\bf Research Intern} at Apple Computer, Inc., Austin, TX,
 USA. \hfill (May 2017-Aug 2017)
 \begin{itemize} \itemsep -2pt  % reduce space between items
...
\section{Education}
{\bf Ph.D., Computer Science} \hfill (graduated May 2021)\\
University of Texas at Austin\\
{\bf B.Tech., Computer Science and Engineering} \hfill (graduated May 2013)\\
...
\section{Research Experience}
 ...
 \item Reasoned about concurrent FS clients, using this separation logic framework, under an oracle model of
   nondeterminism.
 \end{itemize}
 ...
 \item Developed a prototype verifier based on Hoare logic and weakest
   pre-conditions, using the Soot compiler framework and the Z3 theorem prover.
...
\begin{tabular}{l p{3in}}
  \underline{Graduate courses:} CS386L Programming Languages, Convex Optimization \\
  \underline{Undergraduate Courses:} \\
  CS439N Operating Systems, CS340D Debugging and Verifying Programs \\
  CS392F Automated Software Design, CS371G Generic Programming
\end{tabular}
...
\section{Technical \\ Skills}
   \begin{tabular}{l p{3in}}
    ...
    \underline{Other formal verification tools:} JasperGold (FPV and DPV), VC Formal (DPV). \\
...
\section{Scholastic Achievements}
 ...
 \item Completed Cadence's JasperGold certifications covering liveness, free variables, Proof Structure, Proof Master, coverage and security verification apps. \hfill(2026)
