...
\begin{tabular}{l p{3in}}
  \underline{Graduate courses:} Programming Languages, Convex Optimization. \\
  \underline{Undergraduate Courses:} Operating Systems, Debugging and Verifying Programs, \\
